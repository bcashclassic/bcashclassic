...
retcode_t hash_to_uint64_t_map_add(hash_to_uint64_t_map_t *const map,
                                  ...
                                  uint64_t value) {
  hash_to_uint64_t_map_entry_t *map_entry = NULL;

  HASH_FIND(hh, *map, hash, FLEX_TRIT_SIZE_243, map_entry);
  if (map_entry == NULL){
    map_entry = (hash_to_uint64_t_map_entry_t *)malloc(
    sizeof(hash_to_uint64_t_map_entry_t));
...
bool hash_to_uint64_t_map_contains(hash_to_uint64_t_map_t const *const map,
                                  flex_trit_t const *const hash) {
  hash_to_uint64_t_map_entry_t *entry = NULL;
...
void hash_to_uint64_t_map_keys(hash_to_uint64_t_map_t *const map, hash243_set_t * const keys){
  hash_to_uint64_t_map_entry_t *curr_entry = NULL;
  hash_to_uint64_t_map_entry_t *tmp_entry = NULL;
  HASH_ITER(hh, *map, curr_entry, tmp_entry) {
...
size_t hash_to_uint64_t_map_size(hash_to_uint64_t_map_t const map){
...
bool hash_to_uint64_t_map_equal(hash_to_uint64_t_map_t const lhs,
  ...
  hash_to_uint64_t_map_entry_t * rhs_entry = NULL;
  hash_to_uint64_t_map_entry_t *lhs_entry = NULL;
  hash_to_uint64_t_map_entry_t *tmp_entry = NULL;

  HASH_ITER(hh, lhs, lhs_entry, tmp_entry) {
    if (!hash_to_uint64_t_map_find(&rhs,lhs_entry->hash,&rhs_entry)){
      return false;
    }
