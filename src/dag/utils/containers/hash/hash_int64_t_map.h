...
#ifndef __UTILS_CONTAINERS_HASH_HASHint64_t_MAP_H__
#define __UTILS_CONTAINERS_HASH_HASHint64_t_MAP_H__
...
typedef struct hash_to_int64_t_map_entry_s {
    flex_trit_t hash[FLEX_TRIT_SIZE_243];
    int64_t value;
    UT_hash_handle hh;
} hash_to_int64_t_map_entry_t;
...
#endif  // __UTILS_CONTAINERS_HASH_HASHint64_t_MAP_H__
